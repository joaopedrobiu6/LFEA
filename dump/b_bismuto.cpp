...
int main()
{
    auto data = ReadData("bismuto.txt");
    ...
    TH1D h("Dados", "Dados", 320, 23.55, 319 * 5.13 + 23.55);
    ...
    h.SetTitle("Espectro de Energia ^{207}Bi;Energia [keV];Eventos");
    ...
    /* auto menor = new TLine(450, 100, 450, 1000);
    menor->SetLineColor(kRed);
    menor->SetLineWidth(1.5);
    menor->SetLineStyle(9);
    menor->Draw("SAME");

    auto maior = new TLine(600, 100, 600, 1000);
