...
public:
    ...
    // FIT
    void fit();               // faz fit só para fittar os valores, não faz graficos smh
    ...
    void DrawFitErrors(const char *, const char *, const char *, int, const char *); // faz o fit e desenha, com as considerações dos erros ex ey
    void DrawFit(const char *, const char *, const char *, int, const char *);       // faz o fit e desenha, sem os erros
